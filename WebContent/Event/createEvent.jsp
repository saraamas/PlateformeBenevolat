...
<li class="list-group-item d-flex justify-content-between align-items-center border-0 dropdown">
 ...
 <div class="blog-container max-w-2xl mx-auto p-8 bg-white rounded-md shadow-md mt-8">
    ...
    <form action="${pageContext.request.contextPath}/eventServlet?action=create" method="post" enctype="multipart/form-data" class="space-y-4">
        <div>
        ...
        <div>
            ...
            <input type="text" id="dateDebut" name="dateDebut" placeholder="YYYY-MM-DD" required
                class="mt-1 p-2 w-full border rounded-md focus:outline-none focus:border-blue-500">
        </div>

        <div>
            <label for="dateFin" class="block text-sm font-medium text-gray-600">End Date:</label>
            <input type="text" id="dateFin" name="dateFin" placeholder="YYYY-MM-DD" required
                class="mt-1 p-2 w-full border rounded-md focus:outline-none focus:border-blue-500">
        </div>
...
<div class="relative mt-1">
                            ...
                            <div class="flex justify-between items-center">
                                <input type="text" id="file-name" readonly placeholder="Choose a file" class="p-2 w-full border rounded-md focus:outline-none focus:border-blue-500 bg-gray-100">
