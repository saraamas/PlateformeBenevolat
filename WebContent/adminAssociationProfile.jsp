    ...
    <div class="row">
       ...
       <div class="col-md-9 border-right">
            <div class="p-3 py-5">
                ...
                <div>
                    <label>Nom:</label>
                    <span><%= admin.getNom() %></span><br>
                    <label>Description:</label>
                    <span><%= admin.getDescription() %></span><br>
                    <label>Secteur d'Activite:</label>
                    <span><%= admin.getSecteurActivite() %></span><br>
                    <label>Site Web:</label>
                    <span><%= admin.getSiteWeb() %></span><br>
                    <label>Adresse:</label>
                    <span><%= admin.getAdresse() %></span><br>
                    <label>Phone:</label>
                    <span><%= admin.getPhone() %></span><br>
                    <label>Ville:</label>
                    <span><%= admin.getVille() %></span><br>
                    <h3>Adherents</h3>
                    <ul>
                        <!-- Loop through associations -->
                        <% for (Benevole adherent : admin.getAdherents()) { %>
                            <li>${association.nom} - <%= adherent.getNom() %> <%= adherent.getPrenom() %></li>
