...
<li class="list-group-item d-flex justify-content-between align-items-center border-0 dropdown">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; margin:120px;margin-top:80px;">
        ...
        <div class="container mx-auto p-4 text-center" style="display: inline-block; margin-top:130px;">
            <h1 class="text-3xl font-bold mb-2">Welcome to your home page !</h1>
            <h2 class="text-lg text-gray-600 mb-4">${requestScope.userNom}</h2>
    
            <div class="buttons">
                <a href="${pageContext.request.contextPath}/dashboard" class="px-6 py-3 shadow bg-green-500 text-white rounded-md hover:bg-green-600">Dashboard</a>
            </div>
        </div>
