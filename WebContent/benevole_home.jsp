...
<nav id="navbar-main" class="navbar navbar-expand-lg shadow-sm sticky-top">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; margin:120px;margin-top:80px;">
        <div style="display: inline-block;">
            <img src="assets/images/users/user.png" alt="A beautiful sunset">
        </div>
        <div class="container mx-auto p-4 text-center" style="display: inline-block; margin-top:130px;">
            <h1 class="text-3xl font-bold mb-2">Do You want to help people?</h1>
            <h2 class="text-lg text-gray-600 mb-4">Send your requests to organizations</h2>
    
            <div class="buttons">
                <a href="eventServlet?action=view" class="px-6 py-3 shadow bg-green-500 text-white rounded-md hover:bg-green-600">Explore Events</a>
            </div>
        </div>
