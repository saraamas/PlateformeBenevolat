...
<div class="container rounded bg-white mt-5 mb-5">
    <div class="row">
        <div class="col-md-3 border-right">
            ...
            <% } %>
                <span class="font-weight-bold"><%= admin.getNom() %></span>
                <span class="text-black-50"> <%= admin.getSiteWeb() %></span>
            </div>
        </div>
...
<div class="mb-3">
    ...
    <div class="input-group">
        ...
        <button type="button" class="btn btn-success" onclick="document.getElementById('fileInput').click();">Choose File</button>
                    ...
                    Nom: <input type="text" name="nom" value="<%= admin.getNom() %>" class="form-control"><br>
                    Description: <input type="text" name="description" value="<%= admin.getDescription() %>" class="form-control"><br>

                    Secteur d'Activite: <input type="text" name="secteurActivite" value="<%= admin.getSecteurActivite() %>" class="form-control"><br>
                    Site Web: <input type="text" name="siteWeb" value="<%= admin.getSiteWeb() %>" class="form-control"><br>
                    Adresse: <input type="text" name="adresse" value="<%= admin.getAdresse() %>" class="form-control"><br>
                    Phone: <input type="text" name="phone" value="<%= admin.getPhone() %>" class="form-control"><br>
                    Ville: <input type="text" name="ville" value="<%= admin.getVille() %>" class="form-control"><br>
