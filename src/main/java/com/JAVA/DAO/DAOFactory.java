...
public class DAOFactory {
	...
	public AdminAssociationDAO getAdminAssociationDAO() {
		return new AdminAssociationDAOImpl(this);
	}
	public BenevoleDAO getBenevoleDAO() {
		return new BenevoleDAOImpl(this);
	}
